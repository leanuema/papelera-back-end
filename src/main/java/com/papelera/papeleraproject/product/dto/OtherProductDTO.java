...
public class OtherProductDTO implements Serializable {

    private static final long serialVersionUID = -7166893698821746381L;
    ...
    public OtherProductDTO(Long productId,
                              String productName,
