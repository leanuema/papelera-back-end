...
public class PlasticProductDTO implements Serializable {
    ...
    private static final long serialVersionUID = 7667469869413857329L;
    ...
    public PlasticProductDTO(Long productId, String productName, Double productQuantityPrice, Double productUnitPrice,
                             Integer productStatusId, Long featuredStatusId) {
