...
@Entity
@Table(name = "PLASTIC_PRODUCT")
public class PlasticProductModel implements Serializable {
    ...
    public PlasticProductModel() {
    }

    public PlasticProductModel(Long productId, String productName, Double productQuantityPrice,
