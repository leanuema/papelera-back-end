...
public class ProductCartResource implements ProductCartEndPoint {
    ...
    @Override
    public List<ProductInCartDTO> getAllProduct() throws Exception {
    ...
    @GetMapping(value = ProductCartEndPoint.RETRIEVE_ALL_FEATURED_PRODUCT,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Override
    public List<ProductInCartDTO> retrieveAllFeaturedProduct(@RequestParam Long id) throws Exception {
    ...
    @GetMapping(value = ProductCartEndPoint.RETRIEVE_BY_ID_AND_NAME,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Override
    public List<ProductInCartDTO> retrieveByIdAndName(@RequestParam Long id,
